...
public class PickingUpHealthUp {
    ...
    public PickingUpHealthUp(Ship player){
        this.player = player;
    }
    ...
    private void setBoxBorders(HealthUp picked){
    ...
    private void makeAction(HealthUp picked){
        picked.getAction().increaseHealth();
    }

    private void removeObjectFromArray(HealthUp picked){
        SpawnedPowerUps.healthUpArray.remove(picked);
    }
